...
class QbittorrentMcpRs < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      def install
        bin.install "qbittorrent-mcp-rs-0.3.0-aarch64-apple-darwin/qbittorrent-mcp-rs"
      end
    end
    if Hardware::CPU.intel?
      ...
      def install
        bin.install "qbittorrent-mcp-rs-0.3.0-x86_64-apple-darwin/qbittorrent-mcp-rs"
      end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "qbittorrent-mcp-rs-0.3.0-aarch64-unknown-linux-musl/qbittorrent-mcp-rs"
      end
    end
    if Hardware::CPU.intel?
      ...
      def install
        bin.install "qbittorrent-mcp-rs-0.3.0-x86_64-unknown-linux-musl/qbittorrent-mcp-rs"
      end
    end
    if Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "qbittorrent-mcp-rs-0.3.0-arm-unknown-linux-gnueabihf/qbittorrent-mcp-rs"
      end
    end
  end
