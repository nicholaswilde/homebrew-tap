...
- **Gemini CLI:** Used within GitHub Actions to autonomously scan upstream repositories and update formula versions and checksums via custom commands (e.g., `update-formula`, `add-formula`).
